 ...
 */
#define DIO0(timeout)                               SX1276ReadDio0(timeout)
...
#define GET_TICK_COUNT( )                           ( getTickCounter() )
#define TICK_RATE_MS(ms) (ms)

inline long getTickCounter()
{
	long tick = 0;
	struct timeval val = {0, 0};

	gettimeofday(&val, NULL);
	tick = val.tv_sec * 1000 + val.tv_usec / 1000;
