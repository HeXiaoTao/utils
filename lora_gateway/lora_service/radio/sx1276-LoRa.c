...
tLoRaSettings LoRaSettings =
{
    ...
    -2,               // TxPacketTimeout
    5000,             // RxPacketTimeout
	10,				  // PreambleLength (used for preamble)
...
uint32_t SX1276LoRaProcess( void )
{
    ...
    case RFLR_STATE_RX_RUNNING:
        if( DIO0(PacketTimeout) == 1 ) // RxDone
        {
            RxTimeoutTimer = GET_TICK_COUNT( );
            if( LoRaSettings.FreqHopOn == true )
            {
    ...
    case RFLR_STATE_CAD_INIT:    
        ...
        SX1276Write( REG_LR_IRQFLAGSMASK, SX1276LR->RegIrqFlagsMask );
                                    ...
                                    // CadDone                  RxTimeout                   FhssChangeChannel           CadDone
        SX1276LR->RegDioMapping1 = RFLR_DIOMAPPING1_DIO0_10 | RFLR_DIOMAPPING1_DIO1_00 | RFLR_DIOMAPPING1_DIO2_00 | RFLR_DIOMAPPING1_DIO3_00;
